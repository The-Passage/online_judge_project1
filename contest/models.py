...
class contest_problemset(models.Model):
    ...
    problem_input = models.FileField(upload_to='static/contestData/problemset_input/', blank=True)
    problem_out = models.FileField(upload_to='static/contestData/problemset_output/', blank=True)
...
class contest_submission(models.Model):
    ...
    uploaded_file = models.FileField(upload_to='static/contestData/user_submission/')
