...
class problemset(models.Model):
    ...
    problem_input = models.FileField(upload_to='static/problemsdata/inputdata', blank=True)
    problem_output = models.FileField(upload_to='static/problemsdata/outputdata', blank=True)
...
class submission(models.Model):
    ...
    uploaded_file = models.FileField(upload_to='static/problemsdata/submissiondata/')
